package orsac.rosmerta.orsac_vehicle.android.SearchVehicle;
...
public class PreferenceHelper {
    ...
    public static final String ALERT_COUNT         = "alert";
    public static final String ALERT_COUNT_STATUS        = "alert_status";
    ...
    public void putAlertCount(int alert_count){
        editor.putBoolean(IS_CREATED, true);
        editor.putInt(ALERT_COUNT, alert_count);
        editor.commit();
    }
    public int getAlertCount(){

        return pref.getInt(ALERT_COUNT, 0);
    }
    public void putAlertCountStatus(int alert_countstatus){
        editor.putBoolean(IS_CREATED, true);
        editor.putInt(ALERT_COUNT_STATUS, alert_countstatus);
        editor.commit();
    }
    public int getAlertCountStatus(){

        return pref.getInt(ALERT_COUNT_STATUS, 0);
    }
