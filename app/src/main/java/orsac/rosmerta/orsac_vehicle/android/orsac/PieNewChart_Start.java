 ...
 */
public class PieNewChart_Start extends AppCompatActivity {
    ...
    MyTextView ok_submit;
    ImageView home_page;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pie_new_start);

        pieChart = (PieChart) findViewById(R.id.chart);
        labels = new ArrayList<String>();
        entries = new ArrayList<>();
        ok_submit=(MyTextView)findViewById(R.id.ok_submit);
...
*/
       ...
       new GetCompanyDetail().execute();
        home_page.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent inty = new Intent(PieNewChart_Start.this,NavigationActivity.class);
    ...
    class GetCompanyDetail extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            AndyUtils.showCustomProgressDialog(PieNewChart_Start.this,
               ...
               // if(success.equalsIgnoreCase("true")){
                ...
                JSONObject dataObj = null;
                    for (int i = 0; i < jarray.length(); i++) {
                        ...
                        RadioButton rbn = new RadioButton(PieNewChart_Start.this);
                        rbn.setId(i+1);
                        if(i%2==0){
                            rbn.setBackgroundColor(Color.parseColor("#C5CAE9"));
                        }else{
                            rbn.setBackgroundColor(Color.parseColor("#d5c5a4"));
                        }
