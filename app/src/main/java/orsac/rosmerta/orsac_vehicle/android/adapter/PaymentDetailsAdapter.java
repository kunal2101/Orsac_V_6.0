...
public class PaymentDetailsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnMapReadyCallback {
    ...
    public PaymentDetailsAdapter ( Context context, ArrayList<HashMap<String, String>> myDataset, RecyclerView recyclerView) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_payment_detail, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        userViewHolder.txt_date_time.setText(map.get("transaction"));

       // Integer(map_dist.get("dist"))  - Integer(map.get("dist"))

    userViewHolder.txt_distance.setText( map_dist.get ( "datetime" ));
        userViewHolder.txt_ignition.setText(map_dist.get ( "vendor" ));
